...
<body style="background-image: url(../../images/register_background.png);">
<div class="login-page" style="opacity: 0.90;">
    <div class="form">
        ...
        <form class="form-horizontal" method="POST" action="{{ route('password.request') }}">
            ...
            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="email" type="email" class="form-control" name="email" value="{{ $email or old('email') }}" style="width:250px;" required autofocus>
